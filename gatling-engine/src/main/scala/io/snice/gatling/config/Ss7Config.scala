...
class Ss7SimulationConfig(@JsonProperty("imsiStart") _imsiStart: Long,
                          @JsonProperty("imsiEnd") _imsiEnd: Long,
                          @JsonProperty("customGT") _customGT: Long,
                          @JsonProperty("atOnceUsers") _atOnceUsers: Int,
  ...
  val imsiStart = checkNotNull(_imsiStart, "imsiStart cannot be null")
  val imsiEnd = checkNotNull(_imsiEnd, "imsiEnd cannot be null")
  val customGT = checkNotNull(_customGT, "customGT cannot be null")
